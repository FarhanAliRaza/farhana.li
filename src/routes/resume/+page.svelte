<script lang="ts">
	...
	const resumeData = {
		...
		about:
			'Full-stack engineer with 5+ years building production systems at scale. Django core contributor (DSF Member) who shipped template partials via GSoC 2025. Created django-bolt, achieving 100K+ RPS by bridging Python-Django with Rust. 700+ stars and 23K+ downloads. Architected systems processing 100M+ emails at 99.9% uptime. Delivered 50+ freelance projects on Fiverr with a 5★ rating. Expert in Python, Django, Svelte, and Rust with a track record of solving complex performance challenges end-to-end.',
		avatarUrl:
		...
		work: [
			{
				...
				highlights: [
					...
					'Achieved 100K+ RPS for JSON APIs by eliminating Python-Rust copy overhead through pointer-based data transfer, up from a 40K RPS bottleneck.',
			...
			},
			{
				...
				highlights: [
					...
					'Ensured feature stability with 50+ tests covering edge cases, plus comprehensive documentation for the official Django docs.',
					'Achieved merge through 100+ public review iterations with Django maintainers, demonstrating code quality standards.',
					'Mentored new contributors through the Djangonaut Space program, growing the Django contributor community.'
				]
			},
			{
				company: 'Medgebra',
				...
				highlights: [
					...
					'Processed 100,000+ medical PDFs with verifiable citations by building an AI-powered page filtering and tracking pipeline.',
			...
			},
			{
				...
				highlights: [
					'Scaled email verification service to a comprehensive cold email platform, processing 100M+ emails at 99.9% uptime. <a href="https://bulkmailverifier.org" target="_blank" rel="noopener noreferrer">bulkmailverifier.org</a>',
					'Automated campaign management with an AI agent using fine-tuned Qwen 2.5 0.5B for lead scoring and email classification.',
					'Built a distributed architecture handling millions of emails daily using Celery, RabbitMQ, and Redis for real-time processing.'
				]
			}
		],
		education: [
